...
public class Main {
    public static void main(String[] args) {
        ...
        Estudiante estudiante2 = new Estudiante("María", 22, 9.2);
        ...
        Libro libro1 = new Libro("El Quijote", "Cervantes", 25.0);
        ...
        libro1.aplicarDescuento(10); // Descuento del 10%
        libro2.setPrecio(30.0);
        libro2.aplicarDescuento(15, 5.0);
